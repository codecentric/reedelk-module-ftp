...
import de.codecentric.reedelk.ftp.component.ConnectionConfiguration;
import de.codecentric.reedelk.ftp.component.ConnectionMode;
import de.codecentric.reedelk.runtime.api.component.Implementor;
import de.codecentric.reedelk.ftp.component.ConnectionType;
...
public class FTPClientProvider {
    ...
    public FTPClientProvider(Class<? extends Implementor> implementor, ConnectionConfiguration connection) {
        ...
        // Default is FTPS.
        ftp = ConnectionType.FTP.equals(connection.getType()) ? new FTPClient() : new FTPSClient();
        mode = Optional.ofNullable(connection.getMode()).orElse(Default.FTP_DEFAULT_MODE);
